...
Concert.create!(name: "Jackson Hole Rendevous", date: '03/31/2023', price: "free", website: "www.jacksonholerendevous.com", venue_id: 5)
Concert.create!(name: "Lander Presents", date: '04/31/2023', price: "free", website: "landerpresents.com", venue_id: 3)
Concert.create!(name: "Frontier Days", date: '08/31/2023', price: "free", website: "www.frontierdays.com", venue_id: 2)
Concert.create!(name: "Jalan Crossland", date: '04/3/2023', price: "free", website: "www.jalancrossland.com", venue_id: 1)
Concert.create!(name: "Whiskey Mayer", date: '05/3/2023', price: "$30", website: "www.fordcenter.com", venue_id: 4)
Concert.create!(name: "Snoop Dog", date: '7/3/23', price: "$80", website: "www.fordcenter.com", venue_id: 4)
Concert.create!(name: "Garth Broooks Tour", date: '9/9/23', price: "$5", website: "www.garthtours.com", venue_id: 4)
Concert.create!(name: "Lander Presents", date: '04/31/2023', price: "free", website: "landerpresents.com", venue_id: 3)
